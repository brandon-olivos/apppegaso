...
class RegDireccionesPage extends StatefulWidget {
  @override
  State<RegDireccionesPage> createState() => _RegDireccionesPageState();
}

class _RegDireccionesPageState extends State<RegDireccionesPage> {
  ...
  guardarG() {
    return Material(
      ...
      child: MaterialButton(
        ...
        onPressed: () async {
          _listaDirecciones.direccion = direccion.text;
          _listaDirecciones.urbanizacion = urbanizacion.text;
          _listaDirecciones.referencia = referencia.text;
          var ar = await _provider.guardar(_listaDirecciones);
          if (ar == 200) {
      ...
      child: TypeAheadField<Entidad>(
        ...
        onSuggestionSelected: (Entidad suggestion) {
          setState(() {
            ...
            _listaDirecciones.idEntidad = suggestion.id_entidad.toString();

...
import 'package:Pegaso/src/pages/GuiaRemisionElectronica/Actions/GuiaCliente/tablaGc.dart';
...
import 'dart:convert';
import 'package:Pegaso/src/pages/GuiaRemisionElectronica/Actions/verEstadoImprimirGuia.dart';

class EditarGRElectronicaPage extends StatefulWidget {
  final int guiRempegaso;

  EditarGRElectronicaPage({this.guiRempegaso = 0});

  @override
  State<EditarGRElectronicaPage> createState() =>
      _EditarGuiaRemAuxiliarPageState();
}

class _EditarGuiaRemAuxiliarPageState extends State<EditarGRElectronicaPage> {
  ...
  Future refreshList() async {
    ...
    var a = await _providerGRElectronica.getGuiaAuxiliar(widget.guiRempegaso);
    setState(() {
      _guiaRemAux = a;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              if (_guiaRemAux.serie == "V001") {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => VerEstadoImprimirGuiaPage(
                          numSerie: _guiaRemAux.serie,
                          numGuia: _guiaRemAux.numeroGuia)),
                );
              }
            },
          ),
            ...
            child: ListView(children: [
              Column(
                ...
                children: <Widget>[
                  ...
                  //comentariotrs(),
                  //SizedBox(height: 10.0),
                  TablaGc(idGuiaRemision: widget.guiRempegaso),

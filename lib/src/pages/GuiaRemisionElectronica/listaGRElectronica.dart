import 'package:Pegaso/src/pages/GuiaRemisionElectronica/Actions/crearGRElectronica.dart';
...
import 'package:Pegaso/src/pages/GuiaRemisionElectronica/Actions/editarGRElectronica.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class ListaGRElectronica extends StatefulWidget {
  String titulo;

  ListaGRElectronica({this.titulo});
  @override
  _GRElectronicaPageState createState() => _GRElectronicaPageState();
}

class _GRElectronicaPageState extends State<ListaGRElectronica> {
  ...
  Future<Null> refreshList() async {
    ...
    _providerGRElectronica.getListaGuiasAuxiliar('');
    setState(() {});
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => CrearGRElectronicaPage()),
              );
            },
          ),
          IconButton(
      ...
      body: FutureBuilder<List<ListaGuiasRem>>(
        future: _providerGRElectronica.getListaGuiasAuxiliar(''),
    ...
    return ListTile(
      ...
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => EditarGRElectronicaPage(
...
class CustomSearchDelegate extends SearchDelegate {
  final _providerLista = new ProviderGRElectronica();
  @override

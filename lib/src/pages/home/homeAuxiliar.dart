...
import 'package:Pegaso/src/pages/Documentos/Documentos.dart';
...
import 'package:Pegaso/src/Pages/GuiaRemisionElectronica/listaGRElectronica.dart';

class HomePageAux extends StatefulWidget {
  static String route = '/';
...
class _HomePageState extends State<HomePageAux> {
  int currenIndex = 0;
          ...
          switch (nombre) {
            ...
            case 'Guias Remision': //GuiaRemAuxiliar
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => ListaGRElectronica(
                          titulo: 'Guias Remision',
                        )),
              );
              break;
                    ...
                    child: Center(
                      child: GridView.count(
                        ...
                        children: [
                          ...
                          botones(
                              "Procesar Guias", Icons.assignment_late_outlined),
                          //botones("Guias Remision", Icons.book),
                          botones("Guias Remision", Icons.receipt_long_rounded),
                          botones("Seguimiento", Icons.camera_enhance_outlined),
                          botones("Documentos", Icons.vertical_split),

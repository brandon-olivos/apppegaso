...
import 'package:Pegaso/src/pages/SeguimientoNuevo/EditarGRClienteSeguimiento.dart';
import 'package:Pegaso/src/data/provider/providerLista.dart';
import 'package:flutter/material.dart';

class TablaGCSeguimiento extends StatefulWidget {
  int idGuiaRemision;

  TablaGCSeguimiento({this.idGuiaRemision = 0});

  @override
  State<TablaGCSeguimiento> createState() => _TablaGCSeguimientoState();
}

class _TablaGCSeguimientoState extends State<TablaGCSeguimiento> {
          ...
          child: MaterialButton(
            ...
            onPressed: () async {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => EditaGRCSeguimientoPage(
                          guiaCliente: list,
                          id: i,
                        )),
              );

...
class SeguimientoAuxiliarAtePage extends StatefulWidget {
  /// String titulo;
...
class _SeguimientoAgenciaPageState extends State<SeguimientoAuxiliarAtePage> {
  ...
  void initState() {
    ...
    setState(() {
      refreshList();
      _providerLista.getListaSeguimientoAuxiliarAte();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<ListaSeguimientoAgente>>(
        future: _providerLista.getListaSeguimientoAuxiliarAte(),
        builder: (BuildContext context,
            AsyncSnapshot<List<ListaSeguimientoAgente>> snapshot) {
          if (snapshot.hasData) {
            if (snapshot.hasData == false) {
              return Center(
                child: Text("¡No existen regidstros"),
              );
            } else {
              return Center(

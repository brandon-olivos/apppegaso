...
class SeguimientoAgClPage extends StatefulWidget {
  String idGuiaRem, tipo;

  SeguimientoAgClPage({this.idGuiaRem = '', this.tipo = ''});
  @override
  _SeguimientoAgenciaPageState createState() => _SeguimientoAgenciaPageState();
}

class _SeguimientoAgenciaPageState extends State<SeguimientoAgClPage> {
  ...
  ListTile _banTitle(ListaseguimientoAgRC band, i) {
    ...
    return ListTile(
      ...
      onTap: () async {
        var abc = await _providerLista.getConsultaGuiasRC(
